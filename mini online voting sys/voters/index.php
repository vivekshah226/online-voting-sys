            ...
            <?php
                ...
                ?>
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                <th colspan="4" class="bg-green text-white"><h5 class="mb-0">ELECTION TOPIC: <?php echo strtoupper($election_topic); ?></h5></th>
                            </tr>
                            <tr>
                                <th>Photo</th>
                        ...
                        <tbody>
                            <?php
                                $fetchingCandidates = mysqli_query($db, "SELECT * FROM candidates WHERE election_id = '$election_id'") or die(mysqli_error($db));
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <?php
                                        $checkIfVoted = mysqli_query($db, "SELECT * FROM votings WHERE voters_id = '" . $_SESSION['user_id'] . "' AND election_id = '" . $election_id . "'") or die(mysqli_error($db));
                                        $isVoteCasted = mysqli_num_rows($checkIfVoted);
                                        ...
                                        if($isVoteCasted > 0){
                                            ...
                                            ?>
                                                <img src="../assets/images/vote.png" width="100" alt="Vote casted">
                                            <?php
                                            }
                                        }else {
                                    ?>
                                        <button type="button" class="btn btn-md btn-success" onclick="CasteVote(<?php echo $election_id; ?>, <?php echo $candidate_id; ?>, <?php echo $_SESSION['user_id']; ?>)">Vote</button>
                                    <?php
                                        }
                                    ?>    
                                    </td>
