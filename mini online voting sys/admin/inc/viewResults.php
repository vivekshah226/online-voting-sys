...
<div clas="row my-3">
            ...
            <?php
                $fetchingActiveElections = mysqli_query($db, "SELECT * FROM elections WHERE id = '". $election_id .'") or
                die(mysqli_error($db));
            ...
            <?php
                    $fetchingVotesDetails = mysqli_query($db, "SELECT * FROM votings WHERE election_id = '".
                    $election_id ."'");
                    ...
                    <?php
                        while($data = mysqli_fetch_assoc($fetchingVoteDetails))
                        {
                            ...
                            $userData = mysqli_fetch_assoc($fechingUsername);
                            ...
                            $fetchingCandidateName = mysqli_query($db, "SELECT * FROM candidate_details WHERE id = '".
                            $candidate_id ."'") or die(mysqli_error($db));
                            $isDataAvailable = mysqli_num_rows($fetchingCandidateName);
                            $candidateData = mysqli_fetch_assoc($fechingCandidateName);
                            if($isDataAvailable > 0)
                            {
                ...
                <?php
                        ...
                        echo "No any vote detail is avaible";
                    }
                ?>                    
            </table>                
